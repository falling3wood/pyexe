...
class MY_window1(Ui_mainWindow, QMainWindow):
    ...
    def _url_report(self, Host, Args_map):
        """
        發送請求
        :param get_host: url
        :param data: 请求数据josn
  ...
  AiPhoto: '130002'
        ...
        try:
            req, url = HttpClient().request_url(HTTP_METHOD='POST', source='100001', token='null', api_v="0", Host=Host, args_map=Args_map, limiting=True)
            YH_token = req.json()
